...
public class FacebookService implements SocialMediaService {
    ...
    public List<Notification> getNotifications() {
        ...
        notifications.add(new Notification("2", "You have a new friend request!", "Facebook", false));
    ...
    public void markAsUnread(String notificationId) {
        System.out.println("Facebook: Marked notification " + notificationId + " as unread.");
    }
